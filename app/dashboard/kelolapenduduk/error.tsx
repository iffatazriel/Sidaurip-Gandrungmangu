...
export default function PendudukError({
  error,
  reset,
}: {
  ...
  useEffect(() => { console.error('Penduduk error:', error); }, [error]);

  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-8">
      <div className="max-w-md text-center">
        <span className="material-symbols-outlined mb-6 text-7xl text-error">groups</span>
        <h1 className="mb-4 font-headline text-2xl font-extrabold text-primary">Gagal Memuat Data Penduduk</h1>
        <p className="mb-8 text-on-surface-variant">Terjadi kesalahan saat memuat data penduduk. Silakan coba lagi.</p>
