        ...
        <div className="max-w-2xl">
          ...
          <AnimateOnScroll animation="fade-up" delay={200}>
            <div className="flex flex-col gap-2 rounded-xl border border-white/10 bg-surface-container-lowest/10 p-2 shadow-2xl backdrop-blur-xl sm:flex-row sm:items-center">
              ...
              <button className="rounded-lg bg-secondary px-8 py-3 font-bold text-white transition-all hover:bg-on-secondary-container hover:scale-105 active:scale-95">
                Cari Status
              </button>
            </div>
          </AnimateOnScroll>
